...
const consts = {
  ...
  video: {
    ...
    bandwidth: [
      { label: "default", value: null },
      { label: "4096k bps", value: 4096 },
      { label: "2048k bps", value: 2048 },
      { label: "1024k bps", value: 1024 },
      { label: "512k bps", value: 512 },
      { label: "256k bps", value: 256 },
      { label: "128k bps", value: 128 },
    ],
  },
  audio: {
    codec: [
    ...
    bandwidth: [
      { label: "default", value: null },
      { label: "128k bps", value: 128 },
      { label: "64k bps", value: 64 },
      { label: "32k bps", value: 32 },
      { label: "16k bps", value: 16 },
      { label: "8k bps", value: 8 },
    ],
  },
  speaker: {
    volume: [
